...
INSERT INTO Utente (Username, Email, Password) VALUES
    ...
    ('mattia', 'mattia@gmail.com', '1234'),
    ('utente1', 'utente1@gmail.com', '1234');
...
UPDATE Prodotto
SET link_immagine = 'https://www.cafelax.com/cdn/shop/files/31u5shvqjNL._AC_SY780.png?v=1710369741&width=480'
WHERE id = 3;